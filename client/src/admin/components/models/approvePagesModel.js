...
const ApprovePagesModel = ({ editdata }) => {
  const successmsg = () =>
    toast("page approved!", {
      autoClose: 1000,
      closeOnClick: true,
  ...
  const Approve = (e) => {
    axios
      .patch(
        "http://localhost:5000/api/admin/dashboard/pendingPage/approve/" +
          editdata.pId
      )
    ...
    <>
      ...
      >
        <Modal.Header className="theme-bg-orange" closeButton>
          <Modal.Title>
            <h5 className="modal-title fw-bold">Approve Page</h5>
          </Modal.Title>
        </Modal.Header>
...
export default ApprovePagesModel;
