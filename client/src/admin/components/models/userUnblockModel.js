...
const UserUnblockModel = ({ editdata }) => {
  const successmsg = () =>
    toast("user Blocked!", {
      autoClose: 1000,
      closeOnClick: true,
  ...
  const Unblock = (e) => {
    axios
      .patch("http://localhost:5000/api/admin/user/unblock/" + editdata.uId)
    ...
    <>
      ...
      >
        <Modal.Header className="bg-warning" closeButton>
          <Modal.Title>
            <h5 className="modal-title fw-bold">Unblock User</h5>
          </Modal.Title>
        </Modal.Header>
...
export default UserUnblockModel;
