...
import UserBlockModel from "../components/models/userBlockModel";
import UserUnblockModel from "../components/models/userUnblockModel";
...
const UserDetails = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:5000/api/admin/user/" + uId)
      .then((res) => {
        setUser(res.data);
                ...
                <div className="card-body pt-3">
                  <div className="tab-content pt-2">
                    <div className="tab-pane fade show active profile-overview">
                      <h5 className="card-title card-header">Profile Details</h5>
                      ...
                      <div className="card-footer">
                        ...
                        {user.status === "1" ? (
                            <UserBlockModel editdata={user} />
                          ) : (
                            <UserUnblockModel editdata={user} />
                          )}
                      </div>

                      {/* <div className="row">
                        <div className="col-lg-3 col-md-4 label ">Action</div>
                        <div className="col-lg-9 col-md-8">
                          {user.status === "1" ? (
                            <UserBlockModel editdata={user} />
                          ) : (
